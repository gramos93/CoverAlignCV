...
from DetectTop import INPUT_PATH
...
# Charger l'image
image_path = Path(INPUT_PATH / SIDE_A_PATH)
...
if image is None:
    ...
    # Définir les zones de recherche (x, y, largeur, hauteur, angle de rotation)
    zones_recherche = [
    ...
    # Tracer les zones inclinées sur l'image
    ...
    for i, (x, y, largeur, hauteur, angle) in enumerate(zones_recherche):
        ...
        afficher_image(f"Contours détectés (Zone {i + 1})", edges)
